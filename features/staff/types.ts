export type StatusKey = "in_progress" | "not_started" | "completed" | "canceled";
...
export const TAB_ORDER: StatusKey[] = ["in_progress", "not_started", "completed", "canceled"];

export const STATUS_META: Record<
  StatusKey,
  { title: string; bgColor: string; arrowBg: string }
> = {
  in_progress: { title: "In Progress", bgColor: "#3BA0F5", arrowBg: "#1E8AE4" },
